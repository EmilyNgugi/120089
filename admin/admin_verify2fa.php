...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT verification_code FROM admin_credentials WHERE email='$email' AND verification_code ='$entered_code'";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if ($entered_code == $stored_code) {
            ...
            $update_sql = "UPDATE admin_credentials SET email_verified_at=NOW() WHERE email='$email'";
